...
2.  **Complete the Global Fields data.**  These fields apply across all of the languges that your skill supports.
    ...
    *  **For Category, we are building a skill that looks up information, so select "Education & Reference."**
    ...
    *  **Provide testing instructions.** Testing instructions give you an opportunity to explain your skill, and any special or possibly confusing features, to the certification team.  A value is required in this box.
        ...
        *  Since you are using our Team Lookup Sample, make sure to add this sentence to your Testing Instructions:

           ```
           This was built using the Team Lookup Sample.
           ```
...
8.  **Answer each of the Global Fields questions using the guidance below.**  These fields also apply across all of the languages that your skill supports.
    ...
    *  **Does this skill allow users to make purchases or spend real money?** For this "Team Lookup" skill, the answer is no.  For future skills, make sure you answer this appropriately.

    *  **Does this Alexa skill collect users' personal information?** Again, for this "Team Lookup" skill, the answer is no.  If you do collect information about a user, such as names, email addresses, phone numbers, and so forth, ensure that you answer Yes to this question.
        *  Answering "yes" to this question will also require you to provide a link to your Privacy Policy at the bottom of the page.

    *  **Is your skill directed to children under the age of 13?** Because you customized this skill with data you provided, it is possible that you created a skill that targets children under the age of 13.  For the "Team Lookup" skill, the answer is **no** because it doesn't target a specific age group.
...
10. **Privacy Policy URL.** This is an optional field, and should not be required for this "Team Lookup" skill sample.  You can leave it blank.
