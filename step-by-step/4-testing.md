...
6.  **Other testing methods to consider:**
    ...
    *  [Unit Testing with Alexa](https://github.com/alexastaging/skill-sample-nodejs-team-lookup-staging/blob/master/unit-testing.md) - a modern approach to unit testing your Alexa skills with [Postman](http://getpostman.com) and [Amazon API Gateway](http://aws.amazon.com/apigateway).
...
<br/><br/>
<a href="https://github.com/alexastaging/skill-sample-nodejs-team-lookup-staging/blob/master/step-by-step/5-customization.md"><img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_customization._TTH_.png" /></a>
